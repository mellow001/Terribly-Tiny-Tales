  ...
  return (
    <div className="">
      <div className="relative">
        <img src="https://c4.wallpaperflare.com/wallpaper/600/360/964/digital-art-landscape-forest-mountains-wallpaper-preview.jpg" alt="Background" className="block w-full h-[250px]" />
      ...
      <div className='flex flex-col mt-2 lg:w-full'>
        <div className='flex pl-10 ml-12 float-right lg:w-1/4 lg:mt-3 lg:justify-center '>
          <p className='font-bold ml-20'>Harshad Baboria</p>
